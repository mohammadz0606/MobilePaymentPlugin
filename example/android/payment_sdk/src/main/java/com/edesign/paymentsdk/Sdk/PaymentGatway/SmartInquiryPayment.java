...
public class SmartInquiryPayment {
    static Context ctx;
    static String resUrl;
    static StringBuffer requestQuery;
    private static NoSSLv3SocketFactory NoSSLv3Factory;
    public static ArrayList<String> timeOutList ;    public static String SECRET_KEY;
    public static Map<String, String> inquiryResSm;
    ...
    public static void sendRequest(final Context ctx1, String SECRET_KEY1, StringBuffer requestQuery1, String url) {
        ...
        resUrl = url;
        final SmartInquiryPayment.AsyncCallWS2 task = new SmartInquiryPayment.AsyncCallWS2();

        inquiryResSm = new TreeMap<String, String>();
    ...
    /* Smart Route inquiry payment gateway*/
...
//         Output the response
        ...
        try {
            ...
            String value = inquiryResSm.get("Response.estn");
            if (value != null) {
                inquiryResSm.put("Response.estn", inquiryResSm.get("Response.estn") + "=");
            }
        } catch (Exception e) {
            e.printStackTrace();
