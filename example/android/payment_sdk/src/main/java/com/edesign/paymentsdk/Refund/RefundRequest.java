 ...
 * * * * Using this RefundService class merchant mobile application should be able to send a Refund Payment message
...
public class RefundRequest {
    ...
    * Merchant simply create object of RefundRequest and then call this method to add the requested parameter*/
   ...
   *To enabled or disabled Log in EZ-Connect Refund Payment or Smart Route Refund Payment */
