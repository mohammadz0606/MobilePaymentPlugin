...
public class SmartApprovePayment {
    ...
    public static void sendRequest(final Context ctx1, String SECRET_KEY1, StringBuffer requestQuery1, String url) {
        ...
        resUrl = url;
        final SmartApprovePayment.AsyncCallWS2 task = new SmartApprovePayment.AsyncCallWS2();

        approveResSm = new TreeMap<String, String>();
    ...
    /* Smart Route approve payment gateway*/
...
//         Output the response
        ...
        try {
            ...
            String value = approveResSm.get("Response.estn");
            if (value != null) {
                approveResSm.put("Response.estn", approveResSm.get("Response.estn") + "=");
            }
//            paymentStatus = approveResSm.get("Response.StatusCode");
