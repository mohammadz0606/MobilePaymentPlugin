 ...
 */
class SmartRouteInquiryService
/*Context used as a parameter*/(private val context: Context) {
    private var authenticationToken: String? = ""
    private var req = InquiryRequest()
    private var response: InquiryResponse? = null
    private var utility: Utility? = null
    private var param: InquiryCallback? = null
     ...
     */
    fun process(requestSTS: InquiryRequest, param1: InquiryCallback) {
        ...
        if (utility!!.isNetworkAvailable) {
            ...
            if (readGenericFile() != null &&
                ...
                req.getGenericKeyValue().containsKey(Parameters.INQUIRY_END_POINT) &&
                !req.getGenericKeyValue()[Parameters.INQUIRY_END_POINT]!!.isNullOrEmpty() &&
                ...
                if (authenticationToken != null && !authenticationToken!!.isEmpty()) {
                    try {
                        ...
                        var call = apiInterface.mPaymentApi(
                            req.getGenericKeyValue()[Parameters.INQUIRY_END_POINT]!!,
                            req.getParameters()
                        )
