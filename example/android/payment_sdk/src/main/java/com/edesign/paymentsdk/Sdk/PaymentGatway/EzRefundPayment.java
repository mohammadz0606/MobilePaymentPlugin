...
public class EzRefundPayment {
    ...
    public static void sendRequest(final Context ctx1, String SECRET_KEY1, StringBuffer requestQuery1, String url) {
        ...
        resUrl = url;
        final EzRefundPayment.AsyncCallWS2 task = new EzRefundPayment.AsyncCallWS2();

        refundResEz = new TreeMap<String, String>();
    ...
    /* Ez connect refund payment gateway*/
...
//         Output the response
        ...
        try {
            ...
            String value = refundResEz.get("Response.estn");
            if (value != null) {
                refundResEz.put("Response.estn", refundResEz.get("Response.estn") + "=");
            }
            paymentStatus = refundResEz.get("Response.StatusCode");
