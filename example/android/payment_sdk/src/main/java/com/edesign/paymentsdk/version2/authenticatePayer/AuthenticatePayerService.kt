 ...
 */
class AuthenticatePayerService
/*Context used as a parameter*/(private val context: Context) {
    private var authenticationToken: String? = ""
    private var req = AuthenticatePayerRequest()
    private var response: AuthenticatePayerResponse? = null
    private var utility: Utility? = null
    private var param: MyCallback? = null
