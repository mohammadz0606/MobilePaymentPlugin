...
public class EzInquiryPayment {
    ...
    public static void sendRequest(final Context ctx1, String SECRET_KEY1, StringBuffer requestQuery1, String url) {
        ...
        resUrl = url;
        final EzInquiryPayment.AsyncCallWS2 task = new EzInquiryPayment.AsyncCallWS2();
        inquiryResEz = new TreeMap<String, String>();
...
//         Output the response
        ...
        try {
            ...
            String value = inquiryResEz.get("Response.estn");
            if (value != null) {
                inquiryResEz.put("Response.estn", inquiryResEz.get("Response.estn") + "=");
            }
        } catch (Exception e) {
            e.printStackTrace();
