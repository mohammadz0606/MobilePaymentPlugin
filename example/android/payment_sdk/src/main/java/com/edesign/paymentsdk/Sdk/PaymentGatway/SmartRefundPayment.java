...
public class SmartRefundPayment {
    static Context ctx;
    ...
    public static Map<String, String> refundResSm;
    ...
    public static void sendRequest(final Context ctx1, String SECRET_KEY1, StringBuffer requestQuery1, String url) {
        ...
        resUrl = url;
        final SmartRefundPayment.AsyncCallWS2 task = new SmartRefundPayment.AsyncCallWS2();

        refundResSm = new TreeMap<String, String>();
    ...
    /* Smart Route Refund Payment gateway*/
...
//         Output the response
                ...
                System.out.println("OutoutString =" + output.toString());
        ...
        try {
            ...
            String value = refundResSm.get("Response.estn");
            if (value != null) {
                refundResSm.put("Response.estn", refundResSm.get("Response.estn") + "=");
            }
        } catch (Exception e) {
            e.printStackTrace();
