...
/**
 * Created by Airrchip
 * CardType Services class handle the CardType request
...
/*Context used as a parameter*/(private val context: Context) {
    ...
    private var req = CardTypeRequest()
    private var response: CardTypeResponse? = null
    private var utility: Utility? = null
    private var param: CardTypeCallback? = null
    private var call: Call<okhttp3.ResponseBody>?=null
    ...
    fun process(requestSTS: CardTypeRequest, param1: CardTypeCallback) {

        /*Here we assign request object to class level because we used or update CardTypeRequest different method*/
        req = requestSTS
        ...
        if (utility!!.isNetworkAvailable) {
            ...
            if (readGenericFile() != null &&
                ...
                req.getGenericKeyValue().containsKey(Parameters.CARD_TYPE_END_POINT) &&
                !req.getGenericKeyValue()[Parameters.CARD_TYPE_END_POINT]!!.isNullOrEmpty() &&
             ...
             * for secure hash generation check detail inside method*/
                ...
                if (authenticationToken != null && !authenticationToken!!.isEmpty() ) {
                    try {
                        ...
                        call = apiInterface.getCardTypeApi(
